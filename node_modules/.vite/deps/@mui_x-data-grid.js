...
} from "./chunk-LWRGCI3P.js";
import {
  createSvgIcon,
  useId_default
} from "./chunk-R6ICPFQM.js";
import {
  require_react_dom
...
function useGridParamsApi(apiRef) {
  ...
  const getCellValue = React80.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
    const row = apiRef.current.getRow(id);
    if (!row) {
      throw new MissingRowIdError(`No row with id #${id} found`);
...
var GridRootStyles = styled_default("div", {
  ...
  const gridStyle = _extends({
    ...
    [`& .${gridClasses2.columnHeader}:focus,
      & .${gridClasses2.columnHeader}:focus-within,
      & .${gridClasses2.columnHeader}:has(+ .${gridClasses2.columnHeader}:focus),
      & .${gridClasses2.columnHeader}:has(+ .${gridClasses2.columnHeader}:focus-within),
      & .${gridClasses2["columnHeader--withLeftBorder"]},
      & .${gridClasses2["columnHeader--withRightBorder"]},
      & .${gridClasses2.columnHeader}:has(+ .${gridClasses2.filler} + .${gridClasses2["columnHeader--withLeftBorder"]}),
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const goToCell = React156.useCallback((colIndex, rowId, closestColumnToUse = "left") => {
...
var DataGridRaw = React183.forwardRef(function DataGrid(inProps, ref) {
...
var DataGrid2 = React183.memo(DataGridRaw);
